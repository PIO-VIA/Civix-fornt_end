import { LecteurService } from '@/lib/services/LecteurService';
import { Calendar, Vote, CheckCircle2 } from 'lucide-react';

interface HistoriqueVotesProps {
  userId: string;
}
...
export async function HistoriqueVotes({ userId }: HistoriqueVotesProps) {
  try {
    // Récupérer l'historique des votes de l'électeur
    const historique = await LecteurService.obtenirHistoriqueElecteur(
      ...
      return (
        <div className="text-center py-8">
          ...
          <p className="text-gray-600">
            Vous n'avez encore participé à aucune élection.
          </p>
        </div>
      );
    }
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600">
          Impossible de charger votre historique de vote.
        </p>
      </div>
    );
  }
